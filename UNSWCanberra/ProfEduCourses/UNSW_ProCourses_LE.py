...
# MAIN ROUTINE
course_type_links = ["https://www.unsw.adfa.edu.au/study/professional-education-courses/programs"]
course_links = []
...
course_links_file_path = os.getcwd().replace('\\', '/') + '/unsw_pro_courses_links_file'
