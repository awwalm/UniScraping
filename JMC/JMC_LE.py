...
course_type_links = []
course_links = []
each_url = 'https://www.jmcacademy.edu.au/courses'
domain_url = 'https://www.jmcacademy.edu.au/'
...
a_tags = browser.find_elements_by_xpath("//div[starts-with(@class, 'tile theme')]/a[@href]")
for a in a_tags:
...
course_links_file_path = os.getcwd().replace('\\', '/') + '/jmc_links_file'
