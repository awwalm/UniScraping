...
# MAIN ROUTINE
course_links = []
each_url = 'https://divinity.edu.au/study/courses/'
domain_url = 'https://divinity.edu.au/'
...
ul_orderings = soup.find('div', {'class': 'entry-content', 'itemprop': 'text'}).find_all('ul')
if ul_orderings:
...
# FILE
course_links_file_path = os.getcwd().replace('\\', '/') + '/divinity_links_file'
