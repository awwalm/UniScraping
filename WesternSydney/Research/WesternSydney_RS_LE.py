...
# MAIN ROUTINE
course_links = []
each_url = 'https://www.westernsydney.edu.au/future/study/courses/research.html'
...
a_tags = browser.find_elements_by_xpath("//div[@class='course-page entity-base-page base-page page']/article/a[@href]")
for a in a_tags:
...
course_links_file_path = os.getcwd().replace('\\', '/') + '/western_sydney_rs_links_file'
