...
# MAIN ROUTINE
course_links = []
each_url = 'https://www.westernsydney.edu.au/future/study/courses/undergraduate.html'
...
a_tags = soup.find_all('a', {'class': 'js-rte-link'})
if a_tags:
    for a in a_tags:
        link = a['href']
        if link:
...
course_links_file_path = os.getcwd().replace('\\', '/') + '/western_sydney_ug_links_file'
