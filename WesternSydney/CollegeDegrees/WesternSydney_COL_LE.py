...
# MAIN ROUTINE
course_links = []
each_url = 'https://www.westernsydney.edu.au/future/study/application-pathways/the-college/courses.html'
domain_url = 'https://www.westernsydney.edu.au/'
browser.get(each_url)
pure_url = each_url.strip()
each_url = browser.page_source

soup = bs4.BeautifulSoup(each_url, 'html.parser')
a_tags = browser.find_elements_by_xpath("//div[starts-with(@class, 'component component--tile')]/article/a[@href]")
for a in a_tags:
...
course_links_file_path = os.getcwd().replace('\\', '/') + '/western_sydney_col_links_file'
