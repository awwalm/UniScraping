...
# MAIN ROUTINE
course_type_links = []
each_url = 'https://search.unisa.edu.au/s/search.html?collection=study-search&query=&f.Tabs%7Ctab=Degrees+%26+Courses&f.Student+Type%7CpmpProgramsStudentType=International&f.Student+Type%7CpmpProgramsStudentType=Australian&f.Study+Type%7CstudyType=Degree&f.Level+of+study%7CfacetLevelStudy=Undergraduate&f.Location%7CfacetProgramsCampus=All'
    ...
    if divs:
        for div in divs:
            ...
            if a:
                ...
                print(the_link)
                course_links.append(the_link)  # just the first 200

# FILE (OTHER LINKS)
course_links_file_path = os.getcwd().replace('\\', '/') + '/unisa_undergrad_links_file_MAIN'
